<x-tampilan>
    ...
    <div class="container">
        ...
        <div class="container mt-4">
            <h3 class="mb-3">Form Tambah Data Keanggotaan</h3>
            ...
            @csrf
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('nia') is-invalid @enderror" id="nia" name="nia" value="{{ old('nia') }}">@error('nia')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('nama_unix') is-invalid @enderror" id="nama_unix" name="nama_unix" value="{{ old('nama_unix') }}">
                    @error('nama_unix')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
