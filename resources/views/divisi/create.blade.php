        ...
        <div class="container mt-4">
            ...
            @csrf
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control  @error('nama_divisi') is-invalid @enderror" id="nama_divisi" name="nama_divisi" value="{{ old('nama_divisi') }}">
                    @error('nama_divisi')
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('ketua_divisi') is-invalid @enderror" id="ketua_divisi" name="ketua_divisi" value="{{ old('ketua_divisi') }}">
                    @error('ketua_divisi') 
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
